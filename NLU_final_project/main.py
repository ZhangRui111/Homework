...
# # Even the bert_base model is so large that
# # this program must use two cards (>= 11G GPU memory).
...
# # Required parameters # #
# # flags.DEFINE_string("paras name", "default value", "illustration")
# Changed
flags.DEFINE_string(
    "data_dir", "./data/",
...
# Changed
flags.DEFINE_string(
    "bert_config_file", "./pretrained_model/bert_base/bert_config.json",
...
# Changed
flags.DEFINE_string(
    "output_dir", "./logs/bert_output/",
    "The output directory where the model checkpoints will be written.")

# # Other parameters # #
# Changed
flags.DEFINE_string(
    "init_checkpoint", "./pretrained_model/bert_base/bert_model.ckpt",
...
class MyProcessor(object):
    ...
    def get_train_examples(self, data_dir):
        ...
        tsv_f = self._read_tsv(os.path.join(data_dir, "train.tsv"))
        return self._create_examples(tsv_f, "train")
    ...
    def get_labels(self):
        ...
        return ["contradiction", "entailment", "not_entailment"]
