    ...
    with tf.Session() as sess:
        ...
        for epoch_i in range(MAX_EPOCH):
            ...
            if epoch_i % 100 == 0:
                ...
                content = 'epoch, train accuracy = {0} | {1:.4%}'.format(epoch_i, train_accuracy)
                print(content)
...
def main():
    ...
    accuracy = train(1e-3, 64)  # AdamOptimizer 1e-5 slow; 1e-4 normal; 1e-3 diverge
    ...
    print('time: {0:.4f} s.'.format(classified_time))
